...
m2_var_notes_part1 = list(zip([var_traj[i] for i in range(0, len(var_traj), int(N/len(notes_part1)))], sorted_offsets_part1))
...
m2_var_notes_part2 = list(zip([var_traj[i] for i in range(0, len(var_traj), int(N/len(notes_part2)))], sorted_offsets_part2))
