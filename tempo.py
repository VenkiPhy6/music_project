...
"""
og_notes_part1.append(full_part1.getElementsByClass(m21.stream.Part)[0][34][0])
og_notes_part1[len(og_notes_part1)-1].offset = og_notes_part1[len(og_notes_part1)-1].getOffsetInHierarchy(full_part1)
"""
...
"""cp_notes_part1.append(full_part1.getElementsByClass(m21.stream.Part)[0][34][0])
cp_notes_part1[len(cp_notes_part1)-1].offset = cp_notes_part1[len(cp_notes_part1)-1].getOffsetInHierarchy(full_part1)"""

og_part1 = m21.stream.Part(og_notes_part1, id='part1')
shuffled_part1 = m21.stream.Part(cp_notes_part1, id='part1')

c1 = full_part1.getElementsByClass(m21.stream.Part)[0][34][0]
shuffled_part1.append(c1)
...
"""
og_notes_part2.append(full_part2.getElementsByClass(m21.stream.Part)[1][34][0])
og_notes_part2[len(og_notes_part2)-1].offset = og_notes_part2[len(og_notes_part2)-1].getOffsetInHierarchy(full_part2)
"""
...
"""
cp_notes_part2.append(full_part2.getElementsByClass(m21.stream.Part)[1][34][0])
cp_notes_part2[len(cp_notes_part2)-1].offset = cp_notes_part2[len(cp_notes_part2)-1].getOffsetInHierarchy(full_part2.getElementsByClass(m21.stream.Part)[1])"""

og_part2 = m21.stream.Part(og_notes_part2, id='part2')
shuffled_part2 = m21.stream.Part(cp_notes_part2, id='part2')
c2 = full_part2.getElementsByClass(m21.stream.Part)[1][34][0]
shuffled_part2.append(c2)
#shuffled_part2.append(full_part2.getElementsByClass(m21.stream.Part)[1][34][0])
