...
og_notes_part1 = []
for i in full_part1.getElementsByClass(m21.stream.Part)[0].getElementsByClass(m21.stream.Measure)[0:2]:
...
cp_notes_part1 = []
for i in full1_part1.getElementsByClass(m21.stream.Part)[0].getElementsByClass(m21.stream.Measure)[0:2]:
    for j in i.getElementsByClass(m21.note.Note):
...
for i in full_part2.getElementsByClass(m21.stream.Part)[1].getElementsByClass(m21.stream.Measure)[0:2]:
...
cp_notes_part2 = []
for i in full1_part2.getElementsByClass(m21.stream.Part)[1].getElementsByClass(m21.stream.Measure)[0:2]:
    for j in i.getElementsByClass(m21.stream.Voice):
        for k in range(len(j)):
